...
def menu():
    ...
    print '\x1b[1;92m[1]  ROBI (madarchod)'

    print '\x1b[1;92m[2]  AIRTEL(khankirpoy)'

    print '\x1b[1;92m[3]  BANGLALINK(chotmaranirpot)'

    print '\x1b[1;92m[4]  BANGLALINK(Heda)'

    print '\x1b[1;92m[5]  GRAMEEN(bod)'

    print '\x1b[1;92m[6]  TELETALK( Sexy korba)'
